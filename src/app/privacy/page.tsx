...
import { RevealWrapper } from "../components/ui/animation-wrappers";
      ...
      <div className="mx-auto px-6 md:px-32 max-w-4xl">
        ...
        <RevealWrapper delay={0.1}>
          <header className="mb-20">
            <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter mb-6 text-zinc-900 text-shimmer">
              Privacy Policy
            </h1>
