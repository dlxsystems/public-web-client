    ...
    <main className="min-h-screen bg-transparent pt-40 pb-20">
      ...
      <div className="mx-auto px-6 md:px-32 max-w-7xl">
        ...
        <div className="mb-20">
          ...
          <RevealWrapper delay={0.2}>
            <ParallaxWrapper offset={20}>
              <h1 className="text-5xl md:text-8xl font-semibold tracking-tighter text-zinc-900 mb-8 max-w-4xl text-shimmer">
                {study.title}
              </h1>
            </ParallaxWrapper>
          </RevealWrapper>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-20">
          ...
          {/* Content */}
          <RevealWrapper delay={0.6} className="lg:col-span-3">
